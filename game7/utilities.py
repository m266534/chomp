...
def draw_background(screen):
    water = pygame.image.load("../game7/assets/sprites/water.png").convert()
    sand = pygame.image.load("../game7/assets/sprites/sand_top.png").convert()
    seagrass = pygame.image.load("../game7/assets/sprites/seagrass.png").convert()
    ...
    custom_font = pygame.font.Font("../game7/assets/fonts/Black_Crayon.ttf", 75)
